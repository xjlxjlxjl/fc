  ...
  methods: {
    ...
    init() {
      let that = this,
          ...
          },
          {
            ...
            events: {
              "click svg": function(e, value, row, index) {
                $("#unhealthyManage #barcode").modal("show");
              }
            }
          },
          {
              ...
              "click .btn": function(e, value, row, index) {
                ...
                that
                  ...
                  .then(response => {
                    ...
                    $("#unhealthyManage #transfeRecord").modal("show");
                  })
        ...
        data = {
          toolbar: "#unhealthyManage #toolbar",
      ...
      $("#unhealthyManage #table").bootstrapTable(data);
    },
    change() {
      $("#unhealthyManage #switchStore").modal("show");
    },
    refreshed() {
      this.refresh($("#unhealthyManage #table"));
    }
  },
  mounted() {
    this.init();
