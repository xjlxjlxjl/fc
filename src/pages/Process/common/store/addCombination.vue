        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <el-table :data="split_material" border stripe>
              ...
              <el-table-column prop="children" label="关联子料"></el-table-column>
                ...
                <template slot-scope="{ $index, row }">
                  <el-input v-model="row.material_number" size="mini">
                    <el-button
                      ...
                      icon="el-icon-arrow-down"
                      style="padding: 7px 3px;"
                      @click="type = 1;key = $index;getMater(true)"
                    ></el-button>
                  </el-input>
                </template>
              </el-table-column>
            ...
            <el-button size="mini" @click="material.push({})" style="width: 100%;">
  ...
  methods: {
    getMater(search) {
      ...
      that
        ...
        .then(response => {
          ...
          $("#combination .materList").modal("show");
        })
    ...
    addMater() {
      const active = new Map([
        [1, () => {
          this.material.splice(this.key, 1, this.mater.selection)
        }],
        [2, () => {
      ...
      $("#combination .materList").modal("hide");
    },
    add() {
      let arr = [];
      ...
      this
        .$post(`repositories/combination_order/create`, {
          materials: arr
        })
        .then(response => {
          if (response.status != 200) return false;
    ...
    clearForm() {
      $("#combination #addCombination").modal("hide");
      this.material = [{}];
      this.split_material = [{}];
    }
  },
