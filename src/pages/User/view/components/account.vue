      ...
      <el-container>
        <el-row>
          <el-col :md="12" :xs="24">
            ...
            <el-form-item label="部门" v-if="formData.login_type == 2">
              <el-input v-model="formData.branch" disabled></el-input>
            </el-form-item>
            <el-form-item label="职务" v-if="formData.login_type == 2">
          ...
          <el-col :md="12" :xs="24">
            ...
            <el-form-item label="我的二维码">
              <img :src="user.user.qrcode">
            </el-form-item>
            <el-form-item label="公司名称" v-if="formData.login_type == 2">
              <el-input v-model="formData.company" disabled></el-input>
            </el-form-item>
            <el-form-item label="公司地址" v-if="formData.login_type == 2">
              <el-input v-model="formData.company_address" disabled></el-input>
            </el-form-item>
            <el-form-item label="公司代码" v-if="formData.login_type == 2">
...
<script>
  ...
  export default {
    ...
    created() {
      let that = this,loading = this.$loading({ lock: true });
      this.$get('members/user').then( response => {
        loading.close();
        if(response.status != 200)
          return false
