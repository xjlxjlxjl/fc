    ...
    <el-tabs>
      ...
      >
        <div class="securityContant" v-if="item.value == 0">
          <el-input type="password" placeholder="输入原密码" v-model="changePass.oldpassword">
            <i slot="prefix" class="font_family icon-password"></i>
          </el-input>
          <el-input type="password" placeholder="输入新密码" v-model="changePass.password">
            <i slot="prefix" class="font_family icon-password"></i>
          </el-input>
          <el-input type="password" placeholder="确认新密码" v-model="changePass.repassword">
            <i slot="prefix" class="font_family icon-password"></i>
          </el-input>
        ...
        <div class="securityContant" v-else-if="item.value == 1">
          <div v-if="changeMobileState == 1">
            <el-input placeholder="输入原手机号" v-model="changeMobile.oldMobile">
              <i slot="prefix" class="font_family icon-shouji"></i>
            </el-input>
            <el-input type="password" placeholder="输入密码" v-model="changeMobile.password">
              <i slot="prefix" class="font_family icon-password"></i>
            </el-input>
            <el-input placeholder="输入验证码" v-model="changeMobile.oldCode">
          ...
          <div v-else>
            <el-input placeholder="输入新手机号" v-model="changeMobile.newMobile">
              <i slot="prefix" class="font_family icon-shouji"></i>
            </el-input>
            <el-input placeholder="输入验证码" v-model="changeMobile.newCode">
              <i slot="prefix" class="font_family icon-yanzhengma"></i>
  ...
  methods: {
    changePassMethod() {
      const loading = this.$loading({ lock: true }),
        that = this;
      that
        .$post("members/change-pass", that.changePass)
        .then(response => {
          loading.close();
    ...
    changeNewMobile() {
      ...
      that
        .$post("members/user/change-mobile", {
