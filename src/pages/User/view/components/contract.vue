    ...
    <div class="contractList">
      <div class="contractDetail" v-for="(item,index) in tableData" :key="index">
        ...
        <div class="contractContant">
          ...
          <div>
            <a :href="`${ baseUrl } + /orders/contract/pdf/${ item.slug }?download=1`" target="_blank" rel="noopener noreferrer">下载合同</a>
            <a :href="`${ baseUrl } + /orders/contract/pdf/${ item.slug }`" rel="noopener noreferrer">查看合同</a>
          </div>
        </div>
      </div>
    </div>
