  ...
  <el-container class="homeHeader">
    <el-header class="hidden-sm-and-down">
      <div onclick="window.location.href = './index.html'">
        <i class="font_family icon-logo1"></i>
        <el-input placeholder="搜索输入型号/产品名/品牌名等关键字">
      ...
      <div>
        <el-menu background-color="transparent" class="el-menu-demo" mode="horizontal">
          ...
          <el-menu-item index="2">
            <router-link to="">认证公司</router-link>
          </el-menu-item>
    ...
    <el-header class="hidden-md-and-up">
      <section><i class="font_family icon-logo1"></i></section>
      <section>
        <el-button type="text" 
