          ...
          <div class="modalBoxMainContent">
            <div id="userList">
              <el-checkbox-group v-model="userList">
                <el-checkbox v-for="item in groupUser" 
                  :key="item.id" 
                  :label="item.id"
            ...
            <el-button size="mini" type="primary" v-if="groupState == 1" @click="joinGroup(userList, '群聊', groupId)">邀请加入</el-button>
