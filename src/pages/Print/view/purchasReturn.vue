<template>
  <div id="IQCunhealthy">
    ...
    >
      <p style="text-align: center;font-size: 18px;">采购退货单</p>
      ...
      <div style="margin-top: 15px;font-size: 10px;line-height: 2;">
        <p style="display: flex;justify-content: space-between;">
          <span style="width: 50%;">采购退货单号：{{ data.number }}</span>
    ...
    this.$get(url)
      .then(response => {
        ...
        setTimeout(
          () =>
            QRCode.toString(
              `https://www.factoryun.com/print.html#/purchasReturn/${this.$route.params.id}`,
              (err, string) =>
